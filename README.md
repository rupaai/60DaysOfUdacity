...
**Today's Progress**: 
- Formed a study buddy group named **Cognitive Learners**
- Filled up the form for another one to form group with my fellow Bangladeshis.
- Right now working on the fastai course and taking notes.

**New thing(s) learned:** 
- Working on communication skills

**Thoughts:**  Love communicating with people...I get to learn so many new things from them.

------------

### Day 8: July 5, 2019, Fridayday
**Today's Progress**: 
- Attend first virtual meetup of #sg_cognitive-learners
- Revised the first chapter of *The Algorithmic foundations of differential privacy* which I have read earlier.


**New thing(s) learned:** 
- Privacy

**Thoughts:**  Will plan more to work on projects.

------------

### Day 9: July 6, 2019, Saturdayday
**Today's Progress**: 
- Read this paper on hyperparameters: https://arxiv.org/abs/1803.09820 | 
- Especially I read it to learn more about one cycle learning which helps to reduce training time for Deep learning
- Also read related articles about that.


**New thing(s) learned:** 
- Learned about cycle learning

**Thoughts:** Will work more on it .

------------

### Day 10: July 7, 2019, Sunday
**Today's Progress**: 
- Participated on the *Women Who Code* virtual meetup.
- Discussed with a teammate about our project steps.
- Started reading the related research paper for that

**New thing(s) learned:** 
- Explored ideas about song recommendation

**Thoughts:** Really love attending these meetups.


### Day 11: July 8, 2019, Monday
**Today's Progress**: 
- Read the first chapter of *Grokking Deep Learning book* by Andrew Trask to see how it is. And it seemed to be a good one | https://www.manning.com/books/grokking-deep-learning
- Finished week 1 of course 1 of *Mathematics for Machine Learning Specialization*| https://www.coursera.org/learn/linear-algebra-machine-learning.
- Revised some data structures from geeksforgeeks.
- Finding more ways to work on the project of #sg_cognitive-learners
- First meetup with our kaggle group from #sg_spaic-kagglers
- Discussed the upcoming group initiatives for #sg_cognitive-learners
- Working on the **Be a Pytorch Beast** initiative of #sg_novice-ai.
...
**Thoughts:**  Hectic day it was!!! Loved the grokking book

------------

### Day 12: July 9, 2019, Tuesday
**Today's Progress**: 
- Revised the first four modules of Intro to DL with PyTorch as I need to help on *PyTorch Beast Weak*.
- Watched some Data analysis tutorials for our project of #sg_spaic-kagglers
...
**Today's Progress**: 
- Decided the projects for #sg_cognitive-learners. We have three tracks to work on - advanced, medium, beginner. Interested people are welcome to look on.
- Worked on a personal project for Rice Leaf Disease classification. but lacking in dataset. :disappointed: Help is appreciated.
- Worked on math. Needed visualization for the vectors I learned from coursera specialization. So, I checked the Essence of linear algebra course of 3Blue1Brown again. That is the best series for Linear Algebra apart from MIT 18.06.
- Worked on some data preprocessing on Titanic dataset of Kaggle.
- Discussed initiatives of #sg_bangladeshi-schlrs with a friend
6. Meetup with kaggle group from #sg_spaic-kagglers
7. Reading and trying to understand a code on BERT that my friend provided ^_^

**New thing(s) learned:** 
- Learned a lot of libraries regarding BERT which is similar to cyclegan on NLP

**Thoughts:**  Realized taht I love working and it's better when I wake up early.

------------

### Day 14: July 11, 2019, Thursday
**Today's Progress**: 
- Read "Generative Adversarial Nets" paper by Goodfellow.
- Finalized the projects for the group #sg_cognitive-learners I'll be working on a song recommendation project.
- Meetup with from #sg_caffeine_coders team
- Meetup with #sg_bangladeshi-schlrs team
- Meetup with #sg_spaic-kagglers team
- Teamed up for emotion detection project of #sg_caffeine_coders
- Finalized the project I'll be working on for #sg_bangladeshi-schlrs. After some searching, I decided to work on *text summarization*.

**New thing(s) learned:** 
- Learned about a paper which solves simple math problems via neural network.

**Thoughts:**  -

------------

### Break Day: July 12, 2019, Friday

------------

### Day 15: July 13, 2019, Saturday
**Today's Progress**: 
- FInished the GAN paper finally. But needs a looot of clarification!
- A few pages of Deep Learning book by Goodfellow
- Meetup with #sg_wrldwde-women-cdrs team.

**New thing(s) learned:** 
- Learned that I have still a lot to learn on GANs.

**Thoughts:**  I really want to finish this book.

------------

### Day 16: July 14, 2019, Sunday
**Today's Progress**: 

- Revised math concepts
- Revised basic Deep learning concepts that I read this week.
- Mostly worked on the weekly Hackathon


**New thing(s) learned:** 
- Hackathon is a new experience

**Thoughts:** I decided to revise the things I read the earlier day. So, didn't read anything new.

------------

### Day 17: July 15, 2019, Monday
**Today's Progress**: 
- Read about data preprocessing for Song recommendation project
- Mostly worked on the weekly Hackathon with the awesome hackathon team.
- worked a bit more on Dog breed classification.

**New thing(s) learned:** 
- Learned more about transfer learning

**Thoughts:** Love working on teams ^_^

------------

### Day 18: July 16, 2019, Sunday
**Today's Progress**: 
- Did a little data preprocessing for APTOS Blindness detection project
- Finally done with Hackathon. Thanks to my best team mates
- Meetup with the amazing ones @anne @Mohona @Droid @Mushrifah Hasan @Marwa for #sg_depressn-detectn
- worked on fastai course for a while.
- Worked a little on Rice Leaf disease classification.
- Another meetup with @Mohona @Munira Omar @Shubhendu Mishra @Marwa @Richaldo_Elias for #sg_spaic-kagglers

**New thing(s) learned:** 
- Data preprocessing on Kaggle

**Thoughts:** Working on hackathon is exhausting

------------

### Day 19: July 17, 2019, Monday
**Today's Progress**: 
-  Continued reading Deep Learning chapter 2 along with Essence of Linear Algebra videos to visualize better.
- Reading articles for emotion detection project.
- Tried out ways to improve digit recognizer for #sg_spaic-kagglers project
...
**Thoughts:**  Still not good at transfer Learning

------------

### Day 20: July 18, 2019, Tuesday
**Today's Progress**: 
- Worked on rice leaf disease classification using Fastai and now I am in love with it.
- Almost done with Dog breed identification but stuck on a weird error.
- FInished training of Digit recognizer. Will finish the inference part tomorrow.

**New thing(s) learned:** 
- Worked on my first FastAI project

**Thoughts:**  Would like to work more on FastAI.

------------

### Day 21: July 19, 2019, Wednesday
**Today's Progress**: 
- Continued with fastai lesson-3.
- looked through some kaggle kernels to get better idea of the recognizing faces in the wild project.

**New thing(s) learned:** 
- Learning a lot through the kernels

**Thoughts:**  Someday i want to be a kaggle master! 

------------

### Day 22: July 20, 2019, Thursday
**Today's Progress**: 
- Revised Lesson 6 of style transfer and learned more in depth about Gram matrix
- Finally selected for emotion detection project for #sg_caffeine_coders
- Looked through some papers for the #sg_depressn-detectn with @anne @Mohona @Oudarjya Sen Sarma @Marwa @Mushrifah Hasan @Droid
- Started working on Hackathon with @Shahana @Joy Poddar @happycoder354 and still working :sweat_smile:
- Attended a meetup with @Jess @Mohammad Diab @Shashi Gharti @Joyce @Elena Kutanov @Mateusz @Venkata Rathnam Muralidharan @Erika Yoon @Temitope Oladokun @Sergio Valderrama @Dammy @Suraiya Khan @Marwa @Mahedi @Sridhar Ethiraj @Joyce Obi @Sourav @Ayesha Manzur @erinSnPAI @Ahmed MAGDY EISSA @Oudarjya Sen Sarma @Muhammad Naufil @Sarah Majors @Sushil Ghimire @yasser albarbary @LauraT@Helena Barmer

**New thing(s) learned:** 
- Loved the idea of Gram matrix
**Thoughts:** Really want to work more on depression deteciton.

------------

### Day 23: July 21, 2019, Friday
**Today's Progress**: 
-  Mostly worked on the hackathon.
-  worked on tuning the hyperparameters, learned more about scheduler.
...
### Day 24: July 22, 2019, Saturday
**Today's Progress**: 
- Worked till 11 am GMT(5 am my time) for the hackathon..still couldn't do much
- Revising fundamental concepts of deep learning.
- Attended a meetup with @Ashish Shrivastava @Mohona @Sushil Ghimire @sourav kumar @Aarthi Alagammai @Michael Sheinman @Muhammad Wajahat @Dammy @Govind in #sg_dlstarguys| Sorry everyone for being such a shaky host!

**New thing(s) learned:** 
- Hosted a meetup for the first time

------------

### Day 25: July 23, 2019, Sunday
**Today's Progress**: 

- Went through DL interview questions.
- Checked the Style transfer code again from lesson 6 or ud188.


**New thing(s) learned:** 
- Interview questions on Deep learning.

**Thoughts:** I have my first interview tomorrow

------------

### Day 26: July 24, 2019, Monday
**Today's Progress**: 

- Restarted the lesson 3 of this course.
